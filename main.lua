...
function love.draw()
    if lost == 1 then
        ...
        love.graphics.print("You Lost! Press R to reset!", 250, 200,0,3,3)        
    else
    love.graphics.setColor(0, 255, 0, 255)
    love.graphics.print("Controls:", 350, 200,0,3,3)   
    love.graphics.print("Down - drop, up - rotate", 300, 250,0,3,3)  
    end 
